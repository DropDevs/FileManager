...
public class EventHandler implements OnClickListener {
	 ...
	 * most work from the MainActivity activity to the FileManager class.
	 * 
	 * @param context	The context of the main activity e.g  MainActivity
	 * @param manager	The FileManager object that was instantiated from MainActivity
	 */
	...
	/**
	 * This method is called from the MainActivity activity and this has the same
	...
	/**
	 * This method is called from the MainActivity activity and is passed
	 ...
	 * is used in the MainActivity activity. If any icons are to be added, they must
	 * be implemented in the getView method. This class is instantiated once in MainActivity
