package com.example.gaurav.filemanager;
...
public final class MainActivity extends ListActivity {
	public static final String ACTION_WIDGET = "com.nexes.manager.MainActivity.ACTION_WIDGET";
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		final String[] permissions = new String[]{Manifest.permission.ACCESS_WIFI_STATE, Manifest.permission.CHANGE_WIFI_STATE, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE,
        ...
        if (savedInstanceState != null)
        	mHandler = new EventHandler(MainActivity.this, mFileMag, savedInstanceState.getString("location"));
        else
        	mHandler = new EventHandler(MainActivity.this, mFileMag);
    			...
    			rename_create.setOnClickListener(new OnClickListener() {
    				public void onClick (View v) {
    					...
    					if(mFileMag.renameTarget(mFileMag.getCurrentDir() +"/"+ mSelectedListItem, rename_input.getText().toString()) == 0) {
    						Toast.makeText(MainActivity.this, mSelectedListItem + " was renamed to " +rename_input.getText().toString(),
    								Toast.LENGTH_LONG).show();
    					}else
